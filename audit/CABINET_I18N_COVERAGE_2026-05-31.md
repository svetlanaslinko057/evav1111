...
|------|------|------:|----------:|-----:|
| 1 | `ClientProjectPage.js` | 74 | 0 | 1307 |
| 2 | `LandingPage.js` | 66 | 0 | 3006 |
| 3 | `LandingPageLight.js` | 65 | 0 | 2981 |
| 4 | `AdminV2Portfolio.js` | 63 | 0 | 858 |
| 5 | `AdminReconciliation.js` | 57 | 0 | 689 |
| 6 | `AdminIntegrationsPage.js` | 49 | 0 | 679 |
| 7 | `ScopeBuilder.js` | 45 | 0 | 691 |
| 8 | `AdminTeamPanel.js` | 44 | 0 | 359 |
| 9 | `DeveloperWorkspaceV2.js` | 44 | 0 | 295 |
| 10 | `AdminExecutionIntelligence.js` | 42 | 0 | 1763 |
| 11 | `DeveloperGrowthPage.js` | 42 | 0 | 566 |
| 12 | `UnifiedAuthPage.js` | 40 | 0 | 694 |
| 13 | `AdminPaymentsPage.js` | 39 | 0 | 576 |
...
| 18 | `ClientProfilePage.js` | 31 | 0 | 422 |
| 19 | `NewRequest.js` | 30 | 0 | 553 |
| 20 | `PortfolioCaseDetail.js` | 30 | 0 | 717 |
| 21 | `ContractSignEvidencePage.js` | 29 | 0 | 429 |
| 22 | `AcceptanceQueue.js` | 27 | 0 | 359 |
| 23 | `AdminPayoutBatchDetail.js` | 27 | 0 | 419 |
| 24 | `DeveloperWorkPage.js` | 27 | 0 | 525 |
| 25 | `AdminValidationPage.js` | 26 | 0 | 532 |
| 26 | `DeveloperDashboard.js` | 25 | 0 | 360 |
| 27 | `AdminUsersPage.js` | 24 | 0 | 437 |
| 28 | `ClientCabinet.js` | 24 | 0 | 386 |
| 29 | `AdminDeliverableBuilder.js` | 23 | 0 | 489 |
| 30 | `ClientEstimatePage.js` | 23 | 0 | 317 |

## Per-file detail (full list)

### `ClientProjectPage.js` — tByEn=74 hardcoded≈0
### `LandingPage.js` — tByEn=66 hardcoded≈0
### `LandingPageLight.js` — tByEn=65 hardcoded≈0
### `AdminV2Portfolio.js` — tByEn=63 hardcoded≈0
### `AdminReconciliation.js` — tByEn=57 hardcoded≈0
### `AdminIntegrationsPage.js` — tByEn=49 hardcoded≈0
### `ScopeBuilder.js` — tByEn=45 hardcoded≈0
...
### `UnifiedAuthPage.js` — tByEn=40 hardcoded≈0
### `AdminPaymentsPage.js` — tByEn=39 hardcoded≈0
...
### `ClientProfilePage.js` — tByEn=31 hardcoded≈0
### `NewRequest.js` — tByEn=30 hardcoded≈0
### `PortfolioCaseDetail.js` — tByEn=30 hardcoded≈0
...
### `DeveloperWorkPage.js` — tByEn=27 hardcoded≈0
### `AdminValidationPage.js` — tByEn=26 hardcoded≈0
...
### `ClientEstimatePage.js` — tByEn=23 hardcoded≈0
...
### `AdminProjectReprice.js` — tByEn=18 hardcoded≈0
...
### `EstimateResultPage.js` — tByEn=17 hardcoded≈0
### `GPTScopeBuilder.js` — tByEn=17 hardcoded≈0
### `DevWork.js` — tByEn=16 hardcoded≈0
### `ExecutorBoard.js` — tByEn=16 hardcoded≈0
### `AdminFinancialsPage.js` — tByEn=15 hardcoded≈0
### `ClientDashboardOS.js` — tByEn=15 hardcoded≈0
### `AdminLoginPage.js` — tByEn=14 hardcoded≈0
### `ClientAuthPage.js` — tByEn=14 hardcoded≈0
### `ClientProjectWorkspaceOS.js` — tByEn=14 hardcoded≈0
### `DeliverableBuilder.js` — tByEn=14 hardcoded≈0
### `ProjectDetails.js` — tByEn=14 hardcoded≈0
### `TwoFactorSetupPage.js` — tByEn=14 hardcoded≈0
...
### `ClientTransparency.js` — tByEn=12 hardcoded≈0
### `TesterValidationPage.js` — tByEn=12 hardcoded≈0
### `ValidatorMissionsPage.js` — tByEn=12 hardcoded≈0
...
### `ClientBillingOS.js` — tByEn=10 hardcoded≈0
### `DeveloperMarketplace.js` — tByEn=10 hardcoded≈0
### `TesterHub.js` — tByEn=10 hardcoded≈0
### `TesterPerformance.js` — tByEn=10 hardcoded≈0
### `AdminPressureTopology.js` — tByEn=9 hardcoded≈0
### `AdminV2Team.js` — tByEn=9 hardcoded≈0
### `BuilderAuthPage.js` — tByEn=9 hardcoded≈0
### `ClientDocumentsPage.js` — tByEn=9 hardcoded≈0
### `ClientProjects.js` — tByEn=9 hardcoded≈0
### `CreateModuleDominance.js` — tByEn=9 hardcoded≈0
...
### `ClientContractPage.js` — tByEn=8 hardcoded≈0
### `TwoFactorChallengePage.js` — tByEn=8 hardcoded≈0
...
### `ProjectBootingPage.js` — tByEn=5 hardcoded≈0
